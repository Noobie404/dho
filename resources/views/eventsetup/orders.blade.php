        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                for (var i = 0; i < len; i++) {
                    ...
                    $("#order-form-user-all").append('<tr id="rem"><td>'+j+'</td><td><center>' + response[i]['order_confirm_id'] + '</center></td><td>' + response[i]['Name'] + '</td><td>' + response[i]['Email'] + '</td><td>' + response[i]['Mobile'] + '</td><td>'+ response[i]['sold_tickets'] +'</td>'+ action +'<td>_ _ _ _ _ _</td></tr>');
