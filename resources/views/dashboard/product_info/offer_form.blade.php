    ...
    <div class="card-body ">
        ...
        <div class="row mb-2">
            <div class="offset-md-4 col-lg-4 col-md-4 col-sm-4">
                <div class="input-group date" id="id_1">
                    ...
                    <input id="in_datetime" name="offer_start" type="text" class="form-control"
            ...
            <div class="col-lg-4 col-md-4 col-sm-4" style="padding-left: 0;">
                <div class="input-group date" id="id_2">
                    ...
                    <input id="out_datetime" name="offer_end" type="text" class="form-control"
                        style="border-top-left-radius: .25rem;border-bottom-left-radius: .25rem;"
                        required>
                    <div class="input-group-addon input-group-append">
                        <div class="input-group-text">
        ...
        <div id="section">
            <div class="section">
                ...
                <div class=" form-row">
                    <div class="form-group form-line-height col-lg-8 col-md-12">
                ...
                <div class="row mb-2" id="single_subtitle">
                    <div class="col-md-12">
                        <div class="input-group input-group-md">
                            ...
                            <input type="text" id="sub_title_fade" class="form-control"
                                value="{{old('sub_title')}}"
                                name="sub_title" aria-label="Large"
                                aria-describedby="inputGroup-sizing-sm"
                                placeholder="ex:.COM is a TLD">
                        </div>
                    </div>
                </div>
                ...
                <div class="row mb-2" id="double_subtitle">
                    ...
                    <div class=" form-row">
                        <div class="form-group form-line-height col-lg-7 col-md-12">
                            ...
                            <input type="text" name="offer_note" class="form-control"
