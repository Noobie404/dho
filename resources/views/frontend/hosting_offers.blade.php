      ...
      <div class="row">
        ...
        <div class="col-md-6">
          <ul id="tabsJustified" class="nav nav-tabs">
            ...
            <li class="nav-item">
              <a id="exclusive-hosting" data-target="#exclusive-domain-offers" data-toggle="tab" href="">Exclusive Offers</a>
            </li>
            <li class="nav-item">
              <a id="special-hosting" data-target="#special-domain-offers" data-toggle="tab" href="">Special offers</a>
            </li>
            <li class="nav-item">
              <a id="regular-hosting" data-target="#regular-domain-offers" data-toggle="tab" href="">Regular Offers</a>
            </li>
          </ul>
        </div>
        <div class="col-md-3">
