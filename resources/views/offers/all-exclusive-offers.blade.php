<section id="offers">
  ...
  <div class="offer-button" style="padding-bottom:100px;">
    <a id="Domain-exclusive-more" href="javascript:void(0)">More Domain Offers</a>
  </div>
  <script>
    $("#Domain-exclusive-more").click(function(){
      $('#Domain-exclusive')[0].click();
    }); 
  </script>
</section>
<section id="special-offers">
    ...
    <div class="container">
      ...
      <div class="row">
        <div id="owl-demo" class="owl-carousel owl-theme owl-special">
          @foreach($all_offers as $all_offer)
          @if($all_offer->product_cat == "Hosting")
            <div class="col-md-12 items">
              <div class="card">
                <div class="card-header">
                  <div class="row">
  ...
  <div class="offer-button" style="padding-bottom:100px;">
    <a id="Hosting-exclusive-more" href="javascript:void(0)">More Hosting Offers</a>
  </div>
  <script>
    $("#Hosting-exclusive-more").click(function(){
      $('#Hosting-exclusive')[0].click();
    }); 
  </script>
</section>
<section id="regular-offers">
  ...
  <div class="offers-card">
    ...
    <div class="container">
      ...
      <div class="row">
        <div id="owl-demo" class="owl-carousel owl-theme">
          @foreach($all_offers as $all_offer)
          @if($all_offer->product_cat == "Combo")
            <div class="col-md-12 items">
              <div class="card">
                <div class="card-header">
                  <div class="row">
  ...
  <div class="offer-button" style="padding-bottom:100px;">
    <a id="Combo-exclusive-more" href="javascript:void(0)">More Combo Offers</a>
  </div>
  <script>
    $("#Combo-exclusive-more").click(function(){
      $('#Combo-exclusive')[0].click();
    }); 
  </script>
</section>
<section id="special-offers">
  ...
  <div class="offer-button" style="padding-bottom:100px;">
    <a id="Web-Server-exclusive-more" href="javascript:void(0)">More Web-Server Offers</a>
  </div>
  <script>
    $("#Web-Server-exclusive-more").click(function(){
      $('#Web-Server-exclusive')[0].click();
    }); 
  </script>
</section>