...
<script src="https://kit.fontawesome.com/73605b6102.js" crossorigin="anonymous"></script>
  ...
  <ul class="navbar-nav ml-auto">
    ...
    <li class="nav-item">
      <a href="domain_offers.php" class="nav-link">Domain Offers</a>
    </li>
    <li class="nav-item">
      <a href="hosting_offers.php" class="nav-link">Hosting Offers</a>
    </li>
    <li class="nav-item">
      <a href="combo_offers.php" class="nav-link">Combo Offers</a>
    </li>
    <li class="nav-item">
      <a href="web_server_offers.php" class="nav-link">Web-Server offers</a>
    </li>
    <li class="nav-item">
      <ul class="side-menu">
        <li class="nav-item">
